...
export default function NewReportPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // store temporary data in sessionStorage for analysis
      const newReport = {
      ...
      // temporary report for the graph
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="p-8 max-w-md w-full text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Taking you to analyze the radiographs...
          </p>
                      ...
                      {images.map((image) => (
                        <div key={image.id} className="relative group">
                          ...
                          <button
                            ...
                            className="absolute top-1 right-1 bg-destructive hover:bg-destructive/90 text-white rounded-full w-6 h-6 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-xs font-bold"
                          >
                            ✕
                          </button>
